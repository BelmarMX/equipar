    ...
    <div class="bg-unox">
        ...
        <main class="mt-5 mb-5">
            ...
            <section class="container py-5 mb-5">
                <span class="h2 d-block text-center">Productos UNOX&reg; Destacados</span>
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-4 text-center mb-3">
                        <a class="featured-link" href="{{ route('results', ['termino' => 'Bakertop+Mind.Maps', 'filter' => 'y', 'brand' => 'UNOX']) }}">
                            ...
                            Bakertop Mind.Maps&trade;<br>Hornos mixtos profesionales
                        </a>
                    </div>
                    <div class="col-md-4 text-center mb-3">
                        <a class="featured-link" href="{{ route('results', ['termino' => 'Speed-x', 'filter' => 'y', 'brand' => 'UNOX']) }}">
                            ...
                            Speed-x&trade; Digital.ID&trade;<br>Hornos rápidos profesional
                        </a>
                    </div>
                    <div class="col-md-4 text-center mb-3">
                        <a class="featured-link" href="{{ route('results', ['termino' => 'Speed.Pro', 'filter' => 'y', 'brand' => 'UNOX']) }}">
                            ...
                            Speed.Pro&trade;<br>Hornos rápidos profesional
                        </a>
                    </div>
                    <div class="col-md-4 text-center mb-3">

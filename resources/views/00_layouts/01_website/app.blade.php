...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	<head>
		...
		<link rel="stylesheet" href="{{ asset('easy/easy-autocomplete.min.css') }}">
	...
	<body>
		...
		<script> var easyroute = "{{ route('coincidencias') }}" </script>
		<script async src="{{ asset('js/autocomplete.js') }}"></script>

...
<div id="NavigationBar" class="uk-margin-top" uk-grid>
    ...
    <div class="uk-width-expand uk-text-center">
        <h1 class="uk-heading-primary">Edición de portafolio</h1>
    </div>
...
<div class="uk-container uk-margin-top">
    {{-- Form --}}
    <form class="in uk-form-horizontal uk-margin-large" enctype="multipart/form-data" method="POST" action="{{ route('portfolio.update', $entry -> id) }}">
        @csrf
        @method('PUT')
        ...
        <div class="uk-margin uk-text-center">
            ...
            <div class="uk-form-controls">
                <img src="{{ url('storage/'.env('PORTFOLIO_FOLDER').'/' . $entry -> image) }}" width="100%">
            </div>
        </div>
        <div class="uk-margin">

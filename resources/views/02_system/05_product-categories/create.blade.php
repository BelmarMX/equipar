...
@section('title', 'Alta de categoría para productos')
...
<div id="NavigationBar" class="uk-margin-top" uk-grid>
    ...
    <div class="uk-width-expand uk-text-center">
        <h1 class="uk-heading-primary">Alta de categoría para productos</h1>
    </div>
...
<div class="uk-container uk-margin-top">
    {{-- Form --}}
    <form class="in uk-form-horizontal uk-margin-large" enctype="multipart/form-data" method="POST" action="{{ route('product-categories.store') }}">
        @csrf

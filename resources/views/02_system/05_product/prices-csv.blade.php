...
<div class="uk-container uk-margin-top">
	...
	<form class="in uk-form-horizontal uk-margin-large" method="POST" enctype="multipart/form-data" action="{{ route('product.uploadPricesTemplate') }}">
		@csrf
		<div class="uk-margin">
			<input type="hidden" name="csv_file" value="1">
			<label class="uk-form-label" for="form-horizontal-text">Cargar archivo CSV</label>
			<div class="uk-form-controls uk-form-controls-text">
				...
				<div class="uk-alert-primary" uk-alert>
					<p>El archivo debe tener formato .csv,
						<a href="{{ route('product.downloadPricesTemplate') }}" style="font-weight: 600; font-size: 1.5rem !important">
		...
		<div class="uk-text-center">
			<button class="mt-1 uk-button uk-button-primary">Cargar</button>
		</div>
	</form>
</div>
@endsection
                    ...
                    @foreach( $subcategories AS $subcategory )
                        @if( $last >= 12 && $counter >= 12 )
                            @if( $counter == 12 )
                                ...
                                <div uk-dropdown="pos: bottom-justify" class="lesubm">
                            ...
                            @endif
                        @else
                            <li @if($subcategory -> slug == $subcat -> slug) class="uk-active" @endif><a href="{{ route('productos-category', [$category-> slug, $subcategory -> slug]) }}" >{{ $subcategory -> title }}</a></li>
                        @endif
                        @php
                            $counter++;
                        @endphp

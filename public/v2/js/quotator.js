...
"use strict";
/*!********************************************!*\
  !*** ./resources/assets/v2/js/quotator.js ***!
  \********************************************/
...
document.querySelectorAll('[data-quote-add]').forEach(function (element) {
  element.addEventListener('click', function () {
    var product = JSON.parse(this.getAttribute('data-quote-add'));
    var product_stored = JSON.parse(localStorage.getItem('products'));
    ...
    var mod_cant = false;
    product_stored = product_stored.map(function (stored_product) {
    ...
    var to_store = _toConsumableArray(product_stored);

    if (!mod_cant) {
      to_store.push(_objectSpread(_objectSpread({}, product), {}, {
        cant: 1
      }));
    }
    ...
    Toast.fire({
      icon: 'success',
      title: "".concat(product.title, " agregado al cotizador")
    });
...
if (document.getElementById('quotation-table')) {
  if (JSON.parse(localStorage.getItem('products')) && JSON.parse(localStorage.getItem('products')).length > 0) {
    ...
    products.map(function (product, index) {
      html += "<tr data-quote-tr_index=\"".concat(index, "\">\n                <td class=\"pt-3\">\n                    <div class=\"position-relative mb-1 w-75 p-0 mx-auto\">\n                        <input type=\"hidden\" name=\"id[]\" value=\"").concat(product.id, "\">\n                        <label class=\"form-label\" style=\"left:23px\">Cant</label>\n                        <input data-quote-update=\"").concat(product.id, "\"\n                            name=\"qty[").concat(product.id, "][]\"\n                            class=\"form-control text-center\"\n                            type=\"number\"\n                            min=\"1\"\n                            value=\"").concat(product.cant, "\"\n                            required\n                        >\n                    </div>\n                </td>\n                <td>\n                    <div class=\"d-flex align-items-center\">\n                        <div class=\"me-2\">\n                            <img width=\"60\"\n                                height=\"60\"\n                                class=\"img-fluid\"\n                                src=\"").concat(product.image, "\"\n                                alt=\"Vista previa\"\n                            >\n                        </div>\n                        <div>\n                            <strong>").concat(product.model, "</strong><br>\n                            <small>").concat(product.title, "</small>\n                        </div>\n                    </div>\n                </td>\n                <td>\n                    <button data-quote-remove=\"").concat(product.id, "\"\n                        data-quote-index=\"").concat(index, "\"\n                        data-bs-toggle=\"tooltip\"\n                        title=\"Quitar producto del cotizador\"\n                        class=\"btn btn-danger\"\n                    >\n                        <i class=\"bi bi-trash text-white\"></i>\n                    </button>\n                </td>\n            </tr>");
    });
    document.getElementById('quotation-table').innerHTML = html;
  } else {
    document.getElementById('send_form').setAttribute('hidden', 'hidden');
    document.getElementById('quotation-table').innerHTML = "<tr>\n            <td>\n                <div class=\"alert alert-warning\" role=\"alert\">\n                    A\xFAn no has agregado productos al cotizador.\n                </div>\n            </td>\n        </tr>";
  }
} // Actualización de la cantidad de productos


document.querySelectorAll('[data-quote-update]').forEach(function (element) {
  element.addEventListener('change', function () {
    var product_id = parseInt(this.getAttribute('data-quote-update'));
...
document.querySelectorAll('[data-quote-remove]').forEach(function (element) {
  element.addEventListener('click', function () {
    var product_id = parseInt(this.getAttribute('data-quote-remove'));
    var tr_index = parseInt(this.getAttribute('data-quote-index'));
    var product_stored = JSON.parse(localStorage.getItem('products'));
    product_stored = product_stored.filter(function (stored_product) {
      if (stored_product.id !== product_id) {
        console.log(stored_product.id, product_id, stored_product.id !== product_id);
        return stored_product;
      }
    });
    document.querySelector('[data-quote-tr_index="' + tr_index + '"]').remove();
    localStorage.setItem('products', JSON.stringify(product_stored));
...
/******/ })()
;
//# sourceMappingURL=quotator.js.map